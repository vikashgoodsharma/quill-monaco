import { ISSUE_LIST } from '@/constants'; // Import the IssueType interface from your constants file

interface IssueTypesProps {
    setSelectedIssueType: (issueType: any) => void;
}

const IssueTypes = ({ setSelectedIssueType }: IssueTypesProps) => {
    return (
        <div className="">
