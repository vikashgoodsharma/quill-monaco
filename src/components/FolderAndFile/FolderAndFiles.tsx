    ...
    const renderFolder = (folder: Folder) => {
        return (
            <div key={folder.title}>
                ...
                >
                    {isExpanded(folder.title) ? <img src="/SelectedArrow.svg" /> : <img src="/UnselectedArrow.svg" />} {isExpanded(folder.title) ? <img src="/SelectedFolderIcon.svg" /> : <img src="/UnselectedFolder.svg" />} {folder.title}
                </div>
